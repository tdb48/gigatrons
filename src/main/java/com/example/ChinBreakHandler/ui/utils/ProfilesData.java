...
import com.example.ChinBreakHandler.config.ConfigManager;
...
public class ProfilesData
{
	...
	public static String getProfileData(com.example.ChinBreakHandler.config.ConfigManager configManager, char[] password) throws InvalidKeySpecException, NoSuchAlgorithmException, IllegalBlockSizeException, InvalidKeyException, BadPaddingException, NoSuchPaddingException
	{
	...
	private static byte[] getSalt(com.example.ChinBreakHandler.config.ConfigManager configManager)
	{
	...
	private static SecretKey getAesKey(com.example.ChinBreakHandler.config.ConfigManager configManager, char[] password) throws NoSuchAlgorithmException, InvalidKeySpecException
	{
