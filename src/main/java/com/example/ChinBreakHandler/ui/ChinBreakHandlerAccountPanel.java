...
import com.example.ChinBreakHandler.ui.utils.DeferredDocumentChangedListener;
import com.example.ChinBreakHandler.ui.utils.ProfilesData;
...
import static com.example.ChinBreakHandler.ui.ChinBreakHandlerPanel.PANEL_BACKGROUND_COLOR;
...
public class ChinBreakHandlerAccountPanel extends JPanel
{
	...
	private void init()
	{
		...
		JCheckBox profilesButton = new ToggleButton("Profiles");
